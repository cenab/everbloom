  ...
  <table>
    <thead>
      <tr>
        ...
        <th style="width: 15%">RSVP Status</th>
    ...
    <tbody>
      ${guestsToPrint
        ...
        <tr>
          ...
          <td>
            ${guest.photoOptOut ? '<span class="photo-opt-out">No photos</span>' : ''}
          </td>
        </tr>
        `;
        })
  ...
  return (
    <li className="px-4 py-4 flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        ...
        {guest.photoOptOut && <PhotoOptOutBadge />}
        <button
...
/**
 * PhotoOptOutBadge indicates a guest has opted out of being in photos
 * PRD: "Guest can opt out of photo display"
 */
function PhotoOptOutBadge() {
  return (
    <span
      className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium bg-neutral-100 text-neutral-600"
      title="Guest prefers not to appear in photos"
    >
      <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
