-- Initial schema for Wedding Bestie platform
...
CREATE TABLE weddings (
    ...
    plan_id TEXT NOT NULL CHECK (plan_id IN ('starter', 'premium')),
...
-- Note: RLS policies should be added based on your auth implementation
...
-- CREATE POLICY "Users can manage guests in own weddings" ON guests
--     FOR ALL USING (
